  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
      <div class="p-4 border-b border-slate-100 flex items-center justify-between">
        ...
        <span class="text-xs text-slate-400">Total {{ adminStore.applicants.length }} Peserta Uji</span>
      </div>
        ...
        <form @submit.prevent="saveInterview" class="space-y-4 text-xs">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Tuliskan catatan observasi karakter, minat bakat, dan kelayakan..."
            ></textarea>
          </div>

          <div class="p-3 bg-slate-50 rounded-xl border border-slate-200/80 space-y-1 text-slate-600">
